...
INSERT INTO refresh_tokens(token, created_at, updated_at, user_id, expires_at) VALUES($1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, $2, $3) returning token, created_at, updated_at, user_id, expires_at, revoked_at
`
